        ...
        <div className="row mb-5">
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    ...
                    <div className="card-body">
                        <h5 className="card-title mb-0">Daffa</h5>
                        <div className="card-text text-black-50">Api <p className="float-right">5 years</p>
                        </div>
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    ...
                    <div className="card-body">
                        <h5 className="card-title mb-0">Baihaqy</h5>
                        <div className="card-text text-black-50">UX <p className="float-right">5 years</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
            ...
            <div className="col-md-4 col-12 mx-auto my-2">
                <div className="card border-0 shadow-lg p-4">
                    <img src="https://media.beritagar.id/2018-09/cad261d9f3665baeb66c52b38aca6658a1986714.jpg" className="card-img-top" alt="director" />
                    <div className="card-body">
                        <h5 className="card-title mb-0">Bagus</h5>
                        <div className="card-text text-black-50">UI<p className="float-right">8 years</p>
                        </div>
                        <h6 className="mt-5">CONNECT</h6>
                        <div className="d-flex justify-content-around">
                            <FaFacebookSquare className="connect" />
